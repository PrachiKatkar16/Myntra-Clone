...
function Kids({ addToWishlist }) {
  ...
  useEffect(() => {
    fetch('https://myntra-clone-2-jz9i.onrender.com/cloth/category/Child')
      .then(response => {
        if (!response.ok) {
    ...
    <Box>
      ...
      <Box padding="4">
        <Grid templateColumns="1fr 3fr" gap={6}>
          <Box>
            <Text fontWeight="bold" fontSize='4xl' mb={4} color='#ee64a6'>Child: {filteredProducts.length}</Text>
